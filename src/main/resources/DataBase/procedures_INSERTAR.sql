...
BEGIN
	...
	insert into alumnos(nombre,nombre2,apellido,apellido2,curp,fk_id_semestre_grupo,matricula,telefono,email_alumno,estatus,f_id_catedratico_responsable,f_id_usuario)
